...
export default async function GymnastOverview({params}:{params:Promise<{id:string}>}) {
 ...
 if(!gymnast) notFound(); const primary=gymnast.groups.find(x=>x.isPrimary); const programmeContext=gymnast.programmeAssignments[0];
